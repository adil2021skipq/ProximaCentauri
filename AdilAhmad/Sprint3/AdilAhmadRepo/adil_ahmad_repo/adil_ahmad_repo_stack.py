...
import resources.read_table as read
...
class AdilAhmadRepoStack(cdk.Stack):
    ...
    def __init__(self, scope: cdk.Construct, construct_id: str, **kwargs) -> None:
        ...
        urls_table=db.Table(self,id='AdilAhmadURLs',
        partition_key=db.Attribute(name="Links", type=db.AttributeType.STRING))
        apilambda = self.create_lambda('api',"./resources",'backend_lambda.lambda_handler',lambda_role)
