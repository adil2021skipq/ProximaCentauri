...
class MyPipelineStack(core.Stack):
    def __init__(self, scope: core.Construct, construct_id: str, **kwargs):
        ...
        commands=["cd AdilAhmad/Sprint3/AdilAhmadRepo","pip install -r requirements.txt", "npm install -g aws-cdk", "cdk synth"],
        primary_output_directory="AdilAhmad/Sprint3/AdilAhmadRepo/cdk.out",
        role=pipelineroles
        )
        ...
        commands=["cd AdilAhmad/Sprint3/AdilAhmadRepo","pip install -r requirements.txt", "npm install -g aws-cdk", "pytest unit", "pytest integ"],
        role=pipelineroles
        )
