...
class AdilAhmadRepoStack(cdk.Stack):
    ...
    def __init__(self, scope: cdk.Construct, construct_id: str, **kwargs) -> None:
        ...
        # URLS = s3b('beta-adil2-stack-adilbucketd08c6c2a-1tkke1tluurv3').load('urls.json')
        ...
        #     comparison_operator= cloudwatch_.ComparisonOperator.GREATER_THAN_THRESHOLD,
        #     evaluation_periods=1)
        # DBalias = lambda_.Alias(self, "AdilAlias "+construct_id, alias_name="AdilAlias "+construct_id, version=DBlambda.current_version)
